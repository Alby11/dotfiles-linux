...
alias ddf='dot diff'
alias ddfca='dot diff --cached'
alias ddct='dot describe --tags $(dot rev-list --tags --max-count=1)'
alias ddfcw='dot diff --cached --word-diff'
alias ddfs='dot diff --staged'
alias ddft='dot diff-tree --no-commit-id --name-only -r'
alias ddfup='dot diff @{upstream}'
alias ddfw='dot diff --word-diff'
