...
alias dd='dot diff'
alias ddca='dot diff --cached'
alias ddct='dot describe --tags $(dot rev-list --tags --max-count=1)'
alias ddcw='dot diff --cached --word-diff'
alias dds='dot diff --staged'
alias ddt='dot diff-tree --no-commit-id --name-only -r'
alias ddup='dot diff @{upstream}'
alias ddw='dot diff --word-diff'
