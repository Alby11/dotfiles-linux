...
local function font_with_fallback(font_family)
	...
	return wezterm.font_with_fallback({
		...
		"CaskaydiaCove Nerd Font Retina", -- nice double-spaced symbols!
	})
end

local function font_and_rules_for_jetbrains()
	-- Use a _very slightly_ lighter variant, so that regular bold really stand out
	local font = font_with_fallback("CaskaydiaCove Nerd Font Light")
	local font_rules = {
		{
			italic = true,
			font = font_with_fallback("CaskaydiaCove Nerd Font Mono Italic"),
		},
		{
			italic = true,
			intensity = "Bold",
			font = font_with_fallback("CaskaydiaCove Nerd Font Bold Italic"),
		},
		{
			intensity = "Bold",
			font = font_with_fallback("CaskaydiaCove Nerd Font SemiBold"),
		},
	}
